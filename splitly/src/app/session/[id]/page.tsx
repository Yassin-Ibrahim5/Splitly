...
import { subscribeToSession, toggleItemAssignment, addPerson, removePerson } from '@/lib/session';
import type { Session, ReceiptItem } from '@/types';
...
import { updateReceiptImage, updateItems } from '@/lib/session';
...
export default function SessionPage() {
  ...
  return (
    ...
    >
      {/* Header */}
      <header className="sticky top-0 z-50 border-b border-[#2a2a2a] px-8 py-4 flex items-center gap-3 bg-[#0d0d0d]/90 backdrop-blur-xl">
        <span
        ...
        <span className="text-[11px] text-[#666] border border-[#2a2a2a] rounded-full px-2.5 py-0.5 tracking-wider bg-[#1e1e1e]">
          beta
        </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#161616] border border-[#2a2a2a] rounded-2xl p-6 relative overflow-hidden">
              <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-[#c8f060] to-transparent opacity-40" />
              <ItemsList
                items={session.items}
          ...
          {session.items.length > 0 && (
            <div className="col-span-full bg-[#161616] border border-[#2a2a2a] rounded-xl px-6 py-4 flex gap-8 items-center">
              <div>
